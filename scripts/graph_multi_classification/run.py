...
def run(args):
    ...
    from bronx.models.head import graph_multi_classification as heads
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data", type=str, default="IMDBMULTI")
    ...
    structural.add_argument("--head", type=str, default="GraphMultiClassificationPyroHead")

    # functional
    functional = subparsers.add_parser("functional")
    functional.add_argument("--head", type=str, default="GraphMultiClassificationGPytorchHead")

    # parametric
    parametric = subparsers.add_parser("parametric")
    parametric.add_argument("--head", type=str, default="GraphMultiClassificationPyroHead")

    node = subparsers.add_parser("node")
    node.add_argument("--head", type=str, default="GraphMultiClassificationPyroHead")
